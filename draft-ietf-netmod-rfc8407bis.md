...
###  Guidance for Writing the IANA Considerations for RFCs Defining IANA-Maintained Modules {#sec-iana-mm}
   ...
   *  An instruction about how to generate the "revision" statement. The
      ...
      the description text enumerates the changes (e.g., list of the new registration entries).

      + If the changes are triggered by an RFC, the description may also include text such as "Applied updates as specified by RFC XXXX."
